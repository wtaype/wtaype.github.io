    ...
    <div class="skills_container">
      <section class="skills_hero">
        <div class="hero_content">
          ...
          <div class="hero_stats_row">
            <div class="stat_hero"><i class="fas fa-code"></i><div class="stat_info"><span class="stat_number">${s.length}</span><span class="stat_label">Tecnologías</span></div></div>
            <div class="stat_hero"><i class="fas fa-chart-line"></i><div class="stat_info"><span class="stat_number">${Math.round(s.reduce((a,o)=>a+o.porcentaje,0)/s.length)}%</span><span class="stat_label">Promedio</span></div></div>
            <div class="stat_hero"><i class="fas fa-layer-group"></i><div class="stat_info"><span class="stat_number">${[...new Set(s.map(a=>a.categoria))].length}</span><span class="stat_label">Categorías</span></div></div>
          </div>
        </div>
      </section>
      ...
      <section class="experiencia_section">
        ...
        <div class="experiencia_grid">
          <div class="experiencia_card"><i class="fas fa-laptop-code"></i><h3>Frontend Development</h3><p class="exp_numero">${s.filter(a=>a.categoria==="frontend").reduce((a,o)=>a+o.proyectos,0)}+</p><p class="exp_label">Proyectos completados</p></div>
          <div class="experiencia_card"><i class="fas fa-database"></i><h3>Backend & Databases</h3><p class="exp_numero">${s.filter(a=>a.categoria==="backend").reduce((a,o)=>a+o.proyectos,0)}+</p><p class="exp_label">Proyectos completados</p></div>
          <div class="experiencia_card"><i class="fas fa-mobile-screen"></i><h3>Mobile Apps</h3><p class="exp_numero">${s.filter(a=>a.categoria==="mobile").reduce((a,o)=>a+o.proyectos,0)}+</p><p class="exp_label">Proyectos completados</p></div>
          <div class="experiencia_card"><i class="fas fa-paintbrush"></i><h3>Diseño & Creatividad</h3><p class="exp_numero">${s.filter(a=>a.categoria==="design").reduce((a,o)=>a+o.proyectos,0)}+</p><p class="exp_label">Proyectos completados</p></div>
        </div>
      </section>
    </div>
  `);const p=()=>{b(".skills_grid",()=>{e(".skill_card").each(function(a){const o=e(this),i=o.find(".circle_progress"),n=o.find(".porcentaje_numero"),c=parseInt(i.data("porcentaje"));setTimeout(()=>{o.addClass("visible");const l=2*Math.PI*45;i.css("stroke-dashoffset",l-c/100*l);let t=0,g=c/60;const v=setInterval(()=>{t+=g,t>=c?(n.text(c),clearInterval(v)):n.text(Math.floor(t))},25)},a*50)})})},d=()=>{const a=e("#skillsGrid").empty();r.forEach((o,i)=>{a.append(`
      ...
      `)}),p()};e(".categoria_btn").on("click",function(){const a=e(this).data("categoria");e(".categoria_btn").removeClass("active"),e(this).addClass("active"),a==="all"?(r=[...s],e(".skill_card").fadeIn(300)):(r=s.filter(o=>o.categoria===a),e(".skill_card").each(function(){e(this).data("categoria")===a?e(this).fadeIn(300):e(this).fadeOut(300)}))}),d(),console.log("✅ Skills cargados")};export{h as skills};
