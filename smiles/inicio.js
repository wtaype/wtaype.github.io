...
export const init = () => {
  ...
  setInterval(() => {
    ...
    roles.eq(currentRole).addClass('active');
  }, 3000);
    ...
    const proyectos = [
      {
        ...
        descripcion: 'App para cálculos rápidos de descuentos y ajustes',
        url: 'https://dscto.blogspot.com/',
        tags: ['JavaScript', 'PWA', 'Firebase'],
        categoria: 'mobile'
      },
      {
        id: 2,
        ...
        descripcion: 'Herramienta para optimizar y embellecer código',
      ...
      },
      {
        ...
        descripcion: 'Generador inteligente de paletas de colores',
        url: 'https://wicolors.blogspot.com/',
        tags: ['Vue.js', 'Design', 'CSS'],
        categoria: 'web'
      }
    ];
  ...
  $('.filter_btn').on('click', function() {
    ...
    if (filter === 'all') {
      ...
      $('.project_card').each(function() {
        const categoria = $(this).find('.project_link').data('categoria');
        categoria === filter ? $(this).fadeIn(300) : $(this).fadeOut(300);
      });
    }
  });
  ...
  console.log('✅ Inicio cargado - Portafolio Profesional');
};

export const cleanup = () => {
  $('.filter_btn, .hero_actions a').off();
