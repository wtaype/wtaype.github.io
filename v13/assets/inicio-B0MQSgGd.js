import{j as s}from"./vendor-gzd0YkcT.js";import{S as n,b as o}from"./main-B99FtWWd.js";import"./main-BF375fxg.js";const _=()=>{s("#inicio").html(`
  ...
  `);const t=s(".hero_roles .role");let c=0;setInterval(()=>{t.removeClass("active"),c=(c+1)%t.length,t.eq(c).addClass("active")},3e3),o(".hero_stats",()=>{s(".stat_number").each(function(){const i=s(this),e=parseInt(i.data("target"));let a=0;const l=e/50,d=setInterval(()=>{a+=l,a>=e?(i.text(e+"+"),clearInterval(d)):i.text(Math.floor(a))},30)})}),setTimeout(()=>{const i=[{id:1,titulo:"DSCTO - Calculadora Móvil",img:"https://i.postimg.cc/dq8nVhCx/Dscto.png",descripcion:"App para cálculos rápidos de descuentos y ajustes",url:"https://dscto.blogspot.com/",tags:["JavaScript","PWA","Firebase"],categoria:"mobile"},{id:2,titulo:"CODEWIL - Optimizador de Código",img:"https://i.postimg.cc/CSQcPTYm/Codewil.png",descripcion:"Herramienta para optimizar y embellecer código",url:"https://codewil.blogspot.com/",tags:["React","Node.js","API"],categoria:"tools"},{id:3,titulo:"WICOLORS - Paleta de Colores",img:"https://i.postimg.cc/FhkDwWHm/Wiicolors.png",descripcion:"Generador inteligente de paletas de colores",url:"https://wicolors.blogspot.com/",tags:["Vue.js","Design","CSS"],categoria:"web"}];s(".project_card").each(function(e){const a=i[e];s(this).removeClass("skeleton").html(`
        <a href="${a.url}" target="_blank" class="project_link" data-categoria="${a.categoria}">
          <div class="project_img">
            <img src="${a.img}" alt="${a.titulo}" loading="lazy">
            <div class="project_overlay"><i class="fas fa-external-link-alt"></i></div>
          </div>
          <div class="project_info">
            <h3 class="project_title">${a.titulo}</h3>
            <p class="project_desc">${a.descripcion}</p>
            <div class="project_tags">${a.tags.map(l=>`<span class="tag">${l}</span>`).join("")}</div>
          </div>
        </a>
      `)})},800),s(".filter_btn").on("click",function(){const i=s(this).data("filter");s(".filter_btn").removeClass("active"),s(this).addClass("active"),i==="all"?s(".project_card").fadeIn(300):s(".project_card").each(function(){s(this).find(".project_link").data("categoria")===i?s(this).fadeIn(300):s(this).fadeOut(300)})}),o(".about_card",()=>{s(".about_card").each((i,e)=>{setTimeout(()=>s(e).addClass("visible"),i*150)})}),console.log("✅ Inicio cargado")};export{_ as inicio};
