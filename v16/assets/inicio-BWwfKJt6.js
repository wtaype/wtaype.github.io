import{j as a}from"./vendor-gzd0YkcT.js";import{S as n,b as t}from"./main-CqS0Ji2D.js";import"./main-BWbDHTVI.js";const _=()=>{a("#inicio").html(`
  ...
  `);const e=a(".hero_roles .role");let c=0;setInterval(()=>{e.removeClass("active"),c=(c+1)%e.length,e.eq(c).addClass("active")},3e3),t(".hero_stats",()=>{a(".stat_number").each(function(){const i=a(this),s=parseInt(i.data("target"));let l=0;const o=s/50,d=setInterval(()=>{l+=o,l>=s?(i.text(s+"+"),clearInterval(d)):i.text(Math.floor(l))},30)})}),t(".about_card",()=>{a(".about_card").each((i,s)=>{setTimeout(()=>a(s).addClass("visible"),i*150)})}),console.log("✅ Inicio cargado")};export{_ as inicio};
