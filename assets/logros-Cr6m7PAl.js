...
<div class="logros_container">
  ...
  <section class="logros_hero">
    <div class="hero_content">
      ...
      <div class="hero_stats_logros">
        ...
        <div class="stat_logro"><i class="fas fa-certificate"></i><div class="stat_data"><span class="stat_numero">${_}</span>  <span class="stat_texto">Certificaciones</span></div></div>
  ...
  <section class="logros_filtros">
    <div class="filtros_tipos">
      ${f.map(([a,s,o])=>`<button class="tipo_btn${a==="all"?" active":""}" data-tipo="${a}"><i class="${s}"></i><span>${o}</span></button>`).join("")}
    </div>
  </section>
...
<div class="wiModal" id="modalLogro">
  <div class="modalBody modal_logro_body">
    ...
    </div>`),g("modalLogro")};export{S as cleanup,E as init,D as render};
