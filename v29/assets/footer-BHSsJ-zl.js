import{l,k as e,m as i,b as n,v as r,$ as a}from"./main-kOxYqnit.js";function t(){const o=new Date;return`
  ...
  `}a("body").append(t());a("head").append('<style>:root{--bgim:url("/v29/wpuntos.svg")}body{background: var(--bgim), var(--bg)}</style>');a("body").append(`
