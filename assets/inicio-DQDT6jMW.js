  ...
  <section class="hero">
    ...
    <div class="hero_visual">
      <div class="profile_container">
        ...
        <img src="/wilder.webp" alt="Wilder Taype" class="profile_img" loading="lazy">
        <div class="profile_badge"><i class="fas fa-circle"></i><span>Disponible</span></div>
      </div>
      ${m.map(([a,s],e)=>`<div class="floating_tech tech${e+1}" ${p(a)}><i class="${s}"></i></div>`).join("")}
    </div>
  </section>
...
</div>`,S=()=>{let a=0;const s=c(".hero_roles .role");t=setInterval(()=>{s.eq(a).removeClass("active"),a=(a+1)%s.length,s.eq(a).addClass("active")},3e3),l.push(n(".hero_stats",()=>{c(".stat_number").each(function(){const e=c(this),i=+e.data("target"),r=i/50;let o=0;const d=setInterval(()=>{o=Math.min(o+r,i),e.text(o<i?Math.floor(o):`${i}+`),o>=i&&clearInterval(d)},30)})})),l.push(n(".about_card",(e,i)=>setTimeout(()=>c(e).addClass("visible"),i*150)))},T=()=>{clearInterval(t),t=null,l.forEach(a=>a?.disconnect?.()),l=[]};export{T as cleanup,S as init,$ as render};
