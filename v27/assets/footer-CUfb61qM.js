import{l,j as e,k as i,m as n,v as r,$ as a}from"./main-Dq2v4x8O.js";function t(){const o=new Date;return`
  ...
  `}a("body").append(t());a("head").append('<style>:root{--bgim:url("/v27/wpuntos.svg")}body{background: var(--bgim), var(--bg)}</style>');a("body").append(`
